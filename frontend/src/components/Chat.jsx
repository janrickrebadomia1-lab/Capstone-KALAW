...
try {
  ...
  "https://bon-ladder-addition-performer.trycloudflare.com/api/chat",
  {
    method: "POST",
    headers: {
                  ...
                  <div className="bot-row">
                    <span className="bot-avatar">
                      <svg viewBox="0 0 24 24" width="26" height="26" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path d="M22 6.5c-.8.35-1.6.6-2.5.7.9-.55 1.6-1.4 1.9-2.45-.85.5-1.8.85-2.8 1.05A4.4 4.4 0 0 0 15.6 4c-2.45 0-4.4 2-4.4 4.45 0 .35.05.7.1 1.02C7.7 9.3 4.4 7.5 2.2 4.8c-.4.65-.6 1.4-.6 2.2 0 1.55.78 2.9 1.98 3.7-.72-.02-1.4-.22-2-.55v.05c0 2.15 1.5 3.95 3.5 4.35-.36.1-.75.15-1.15.15-.28 0-.55-.03-.82-.08.55 1.75 2.15 3 4.05 3.05A8.8 8.8 0 0 1 1 19.55 12.4 12.4 0 0 0 7.7 21.5c8 0 12.4-6.7 12.4-12.5 0-.2 0-.4-.02-.6.85-.6 1.6-1.4 2.2-2.3-.78.35-1.6.6-2.5.7A4.4 4.4 0 0 0 22 6.5Z"/>
                      </svg>
                    </span>
                  ...
                  <div className="user-row">
                    ...
                    <span className="user-avatar">
                      <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 12c2.7 0 4.9-2.2 4.9-4.9S14.7 2.2 12 2.2 7.1 4.4 7.1 7.1 9.3 12 12 12Zm0 2.4c-3.27 0-9.8 1.64-9.8 4.9v2.5h19.6v-2.5c0-3.26-6.53-4.9-9.8-4.9Z"/>
                      </svg>
                    </span>
                  </div>
                )}
